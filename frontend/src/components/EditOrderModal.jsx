...
const EditOrderModal = ({ order, onClose, onUpdateOrder }) => {
  const [formData, setFormData] = useState({
    ...
    notes: order.notes || '',
    estimatedCompletion: new Date(order.estimatedCompletion).toISOString().slice(0, 16)
  });
  ...
  const staffMembers = ['Lisa Park', 'David Rodriguez', 'Maria Garcia', 'Anna Kim', 'Unassigned'];
      ...
      <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden shadow-2xl">
        ...
        <div className="bg-gradient-to-r from-orange-600 to-red-600 text-white p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-orange-100 mt-1">Order ID: {order.id}</p>
            </div>
            <button
              onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto max-h-[75vh]">
          ...
          <div className="flex justify-end space-x-4 mt-8 pt-6 border-t border-gray-200">
            ...
            <button
              type="submit"
              className="px-6 py-2 bg-gradient-to-r from-orange-600 to-red-600 text-white rounded-lg hover:from-orange-700 hover:to-red-700 transition-all transform hover:scale-105"
            >
              Update Order
            </button>
          </div>
