...
export default function DeliveryBoyLogin() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      // Directly use backend authentication for delivery boys (skip Firebase)
      console.log("DeliveryBoyLogin: Attempting direct backend authentication");
      ...
      console.error("DeliveryBoyLogin: Unexpected error during authentication:", error);
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-4 py-16 sm:px-8">
        <div className="grid w-full max-w-md gap-8">
          <div className="space-y-6 text-center">
            ...
            <div>
              <h2 className="text-3xl font-bold text-white">Delivery Boy Login</h2>
              <p className="mt-2 text-emerald-100/80">
                Sign in to your delivery boy account
              </p>
            </div>
          </div>
